...
# Script to run examples quantity experiment: 0 Correct, 0 Incorrect
# Evaluates 5 selected students: alu1, alu2, alu3, alu8, alu10
# WITHOUT RAG, WITHOUT FUNCTION ANALYZER
# This is a baseline test with NO examples provided
...
OUTPUT_DIR="outputs/examples_quantity_experiment/0c_0i/${TIMESTAMP}"
SYSTEM_CONFIG="runners/config/examples_quantity_experiment/0c_0i.yaml"
EVALUATOR_CONFIG="runners/config/eval_config.yaml"

echo "=========================================="
echo "EXAMPLES QUANTITY EXPERIMENT - 0C_0I"
echo "=========================================="
...
echo "Example config: 0 correct, 0 incorrect (NO EXAMPLES)"
...
echo "🚀 Running evaluation with 0 correct and 0 incorrect examples (baseline)..."
echo ""
...
uv run python runners/run_supervised_individual_evaluator.py \
    ...
    --experiment-name "examples_quantity_0c_0i_${TIMESTAMP}" \
    --verbose
