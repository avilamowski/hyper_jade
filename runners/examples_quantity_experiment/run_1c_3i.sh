...
# Script to run examples quantity experiment: 1 Correct, 3 Incorrect
...
OUTPUT_DIR="outputs/examples_quantity_experiment/1c_3i/${TIMESTAMP}"
SYSTEM_CONFIG="runners/config/examples_quantity_experiment/1c_3i.yaml"
EVALUATOR_CONFIG="runners/config/eval_config.yaml"

echo "=========================================="
echo "EXAMPLES QUANTITY EXPERIMENT - 1C_3I"
echo "=========================================="
...
echo "Example config: 1 correct, 3 incorrect"
...
echo "🚀 Running evaluation with 1 correct and 3 incorrect examples..."
echo ""
...
uv run python runners/run_supervised_individual_evaluator.py \
    ...
    --experiment-name "examples_quantity_1c_3i_${TIMESTAMP}" \
    --verbose
