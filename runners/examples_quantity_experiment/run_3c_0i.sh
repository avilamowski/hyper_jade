...
# Script to run examples quantity experiment: 3 Correct, 0 Incorrect
...
OUTPUT_DIR="outputs/examples_quantity_experiment/3c_0i/${TIMESTAMP}"
SYSTEM_CONFIG="runners/config/examples_quantity_experiment/3c_0i.yaml"
EVALUATOR_CONFIG="runners/config/eval_config.yaml"

echo "=========================================="
echo "EXAMPLES QUANTITY EXPERIMENT - 3C_0I"
echo "=========================================="
...
echo "Example config: 3 correct, 0 incorrect"
...
echo "🚀 Running evaluation with 3 correct and 0 incorrect examples..."
echo ""
...
uv run python runners/run_supervised_individual_evaluator.py \
    ...
    --experiment-name "examples_quantity_3c_0i_${TIMESTAMP}" \
    --verbose
