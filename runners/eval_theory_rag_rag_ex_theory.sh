...
# Theory/RAG Experiment Runner: rag_ex_theory
...
SYSTEM_CONFIG="runners/config/theory_rag_experiment/rag_ex_theory.yaml"
...
echo "Running rag_ex_theory experiment $ITERATIONS time(s)..."
echo "Config: RAG=true, Example Theory=true, Corrector Theory=false"
...
for i in $(seq 1 $ITERATIONS); do
    ...
    OUTPUT_DIR="outputs/evaluation/theory_rag_experiment/rag_ex_theory/${TIMESTAMP}"
    ...
    uv run runners/run_supervised_individual_evaluator.py \
        ...
        --experiment-name "rag_ex_theory_${TIMESTAMP}" \
        --verbose
...
echo ""
echo "============================================================"
echo "Completed $ITERATIONS rag_ex_theory evaluation run(s)"
echo "============================================================"
