...
# Theory/RAG Experiment Runner (P2 Ej1): ex_theory
...
echo "Running ex_theory experiment (P2 Ej1) $ITERATIONS time(s)..."
...
for i in $(seq 1 $ITERATIONS); do
    ...
    OUTPUT_DIR="outputs/evaluation/p2_ej1_theory_rag_experiment/ex_theory/${TIMESTAMP}"
    ...
    uv run runners/run_supervised_individual_evaluator.py \
        ...
        --experiment-name "ex_theory_p2_ej1_${TIMESTAMP}" \
        --verbose
