...
# Theory/RAG Experiment Runner (P2 Ej1): rag
...
echo "Running rag experiment (P2 Ej1) $ITERATIONS time(s)..."
...
for i in $(seq 1 $ITERATIONS); do
    ...
    OUTPUT_DIR="outputs/evaluation/p2_ej1_theory_rag_experiment/rag/${TIMESTAMP}"
    ...
    uv run runners/run_supervised_individual_evaluator.py \
        ...
        --experiment-name "rag_p2_ej1_${TIMESTAMP}" \
        --verbose
