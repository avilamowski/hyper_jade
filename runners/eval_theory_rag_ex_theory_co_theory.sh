...
# Theory/RAG Experiment Runner: ex_theory_co_theory
# Variables: RAG=false, Example Theory=true, Corrector Theory=true
...
SYSTEM_CONFIG="runners/config/theory_rag_experiment/ex_theory_co_theory.yaml"
...
echo "Running ex_theory_co_theory experiment $ITERATIONS time(s)..."
echo "Config: RAG=false, Example Theory=true, Corrector Theory=true"
...
for i in $(seq 1 $ITERATIONS); do
    ...
    OUTPUT_DIR="outputs/evaluation/theory_rag_experiment/ex_theory_co_theory/${TIMESTAMP}"
    ...
    uv run runners/run_supervised_individual_evaluator.py \
        ...
        --experiment-name "ex_theory_co_theory_${TIMESTAMP}" \
        --verbose
...
echo ""
echo "============================================================"
echo "Completed $ITERATIONS ex_theory_co_theory evaluation run(s)"
echo "============================================================"
