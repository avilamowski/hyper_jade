...
# Script to run 3p experiment WITH AST function grouper
# Evaluates 5 selected students: alu1, alu2, alu3, alu8, alu10
# WITH FUNCTION ANALYZER: Uses AST-based function grouping for code correction
...
OUTPUT_DIR="outputs/ast_grouped_functions_experiment/evaluation_with_ast/${TIMESTAMP}"
SYSTEM_CONFIG="runners/config/with_function_analyzer.yaml"
EVALUATOR_CONFIG="runners/config/eval_config.yaml"

echo "=========================================="
echo "3P EXPERIMENT - WITH AST"
echo "=========================================="
...
echo "🚀 Running evaluation WITH AST function grouper..."
echo ""
...
uv run python runners/run_supervised_individual_evaluator.py \
    ...
    --experiment-name "3p_experiment_with_ast_${TIMESTAMP}" \
    --verbose

echo ""
echo "✅ Evaluation WITH AST completed!"
